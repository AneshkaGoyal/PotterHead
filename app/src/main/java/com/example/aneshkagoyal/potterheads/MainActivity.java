...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view){
        ...
        int total = cal(ans1,ans2,numberOfChildren,isAns_4Correct,ans5,ans6);
        print_score(total);
    ...
    public void print_score (int num){
        if(num<60)
        {
            Toast.makeText(this, "SCORE IS "+num, Toast.LENGTH_SHORT).show();
        }
        else if(num==60){
            Toast.makeText(this, "Congrats Potter head...Score "+num, Toast.LENGTH_SHORT).show();
        }
    }
